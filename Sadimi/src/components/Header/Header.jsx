    ...
    return (
        ...
        <header className='flex w-full min-w-96 flex-col'>
            <div className='flex h-16 w-full flex-row items-center justify-between px-2 sm:px-4'>
                ...
                <h1 className='mx-auto flex p-2 px-4 text-center font-cursive text-4xl font-bold text-primero hover:scale-105 hover:cursor-pointer md:flex md:w-80'>Sadimi</h1>
