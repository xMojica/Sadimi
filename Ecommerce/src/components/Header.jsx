...
function Header() {
    return (
        <header className='flex h-16 w-full flex-row items-center justify-evenly px-2 sm:px-4'>
            ...
            <h1 className='hidden p-2 px-4 text-center font-cursive text-4xl text-primero hover:scale-105 hover:cursor-pointer md:flex md:w-80'>Sadimi</h1>
